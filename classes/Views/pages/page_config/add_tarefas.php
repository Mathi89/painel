...
<div class="containersettings">
    ...
    <section id="" class="section-painelConfig">
	     <section id="" class="section-configMob">
                <h1 class="titulo titulo_display_inline">Adicione uma nova tarefa em: <span class="titulo_pcontato">TITULO DO PONTO</span></h1>
                <div class="allForm">
                    <div class="corpo_form_create_new_contact">
                        <form method="post" id="formpContato1">
                                ...
                                <div data-pcontato="<?= $_GET['pcontato']?>" class="form_group_partes_createnewcontact">
